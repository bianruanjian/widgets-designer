import { SpacingProperties, FlexContainerProperties, FlexItemProperties, BorderProperties, TextProperties, ColorsProperties, DisplayProperties } from './interfaces';
...
export function getDisplayClasses(properties: DisplayProperties): string[] {
    let {
        display
    } = properties;
    ...
    if(display){
        displayClasses.push(displayMap[display]);
    }
